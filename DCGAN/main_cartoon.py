...
from dcgan_cartoon import Generator, Discriminator
from torchvision.utils import save_image
from torchvision import datasets, transforms
sys.path.append("/data/bitt/wzq/wzq/GANs/")
from utils import AverageMeter, ProgressMeter
from utils import Cartoon
...
def predict(generator, discriminator, device, criteria, epoch):
    ...
    generator.eval()
    with torch.no_grad():
        output = generator(z).view(-1, 3, 64, 64)
        ...
        save_image(img, './DCGAN/log_cartoon/sample_{}.png'.format(epoch))
    return val_loss
...
def main():
    ...
    data_train = Cartoon("./data/extra_data", transform)
    ...
    for epoch in range(19):
        ...
        if val_loss.item() < min_loss:
            ...
            torch.save(generator.state_dict(),
                       'DCGAN/checkpoints_cartoon/generator_best.pt')
            torch.save(discriminator.state_dict(),
                       'DCGAN/checkpoints_cartoon/discriminator_best.pt')
    writer.close()
    print("finish")
